...
const Head = ({ title }) => {
  return (
    <>
      <Helmet
        htmlAttributes={{ lang: "en-GB", title: "Jay's Site" }}
        defaultTitle="Jay's website | My website"
        title={title}
      ...
      >
        <meta
          ...
          // title={title || "Jay Fergs website"}
          // titleTemplate="%s | My website"
        />

        <meta
          name="keywords"
          content="UX, Design, Developer, Web, User Interface, UI, Canada"
        ></meta>
        ...
        <meta
          ...
          content="My website for webdev, UX, and more"
        />
        ...
        <meta
          ...
          content="My twitter for webdev, UX and anything else that interests me "
        />
